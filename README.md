...
<svg width="900" height="200" viewBox="0 0 900 200" xmlns="http://www.w3.org/2000/svg">
  <defs>
    ...
    <radialGradient id="glow1" cx="30%" cy="60%" r="50%">
  ...
  <!-- Dark background -->
  <rect width="900" height="200" fill="url(#aurora1)" rx="12"/>

  <!-- Aurora glow blobs -->
  <ellipse cx="270" cy="120" rx="300" ry="80" fill="url(#glow1)" filter="url(#blur2)">
    <animate attributeName="cx" values="270;320;270" dur="8s" repeatCount="indefinite"/>
    <animate attributeName="opacity" values="1;0.7;1" dur="5s" repeatCount="indefinite"/>
  </ellipse>
  <ellipse cx="630" cy="80" rx="280" ry="70" fill="url(#glow2)" filter="url(#blur2)">
    <animate attributeName="cx" values="630;580;630" dur="7s" repeatCount="indefinite"/>
    <animate attributeName="opacity" values="0.8;1;0.8" dur="6s" repeatCount="indefinite"/>
  </ellipse>
  <ellipse cx="450" cy="160" rx="200" ry="50" fill="url(#glow3)" filter="url(#blur1)">
    <animate attributeName="cy" values="160;140;160" dur="9s" repeatCount="indefinite"/>
  </ellipse>

  <!-- Subtle grid lines -->
  <g stroke="#00ff8815" stroke-width="0.5">
  ...
  <g fill="#00ff88" opacity="0.6">
    <circle cx="60" cy="40" r="2"><animate attributeName="opacity" values="0.6;1;0.6" dur="3s" repeatCount="indefinite"/></circle>
    <circle cx="120" cy="160" r="1.5"><animate attributeName="opacity" values="1;0.4;1" dur="4s" repeatCount="indefinite"/></circle>
    <circle cx="840" cy="50" r="2"><animate attributeName="opacity" values="0.4;1;0.4" dur="2.5s" repeatCount="indefinite"/></circle>
    <circle cx="800" cy="150" r="1.5"><animate attributeName="opacity" values="1;0.5;1" dur="3.5s" repeatCount="indefinite"/></circle>
  </g>
  <g fill="#7c3aed" opacity="0.7">
    <circle cx="180" cy="100" r="1.5"><animate attributeName="opacity" values="0.7;1;0.7" dur="4s" repeatCount="indefinite"/></circle>
    <circle cx="720" cy="100" r="2"><animate attributeName="opacity" values="1;0.5;1" dur="3s" repeatCount="indefinite"/></circle>
  </g>

  <!-- Name text -->
  <text x="450" y="90" font-family="'Courier New', monospace" font-size="26" font-weight="bold"
        text-anchor="middle" fill="#e2e8f0" letter-spacing="3">
  ...
  <line x1="200" y1="145" x2="700" y2="145" stroke="url(#aurora1)" stroke-width="0"/>
  <line x1="280" y1="148" x2="620" y2="148" stroke="#7c3aed" stroke-width="0.8" opacity="0.6"/>

  <!-- Tagline -->
  <text x="450" y="175" font-family="'Courier New', monospace" font-size="11"
        text-anchor="middle" fill="#64748b" letter-spacing="4">
    ⟨ SECURITY • CODE • DEFENSE ⟩
  </text>
</svg>

<!-- ============================================================ -->
<!--           TYPING EFFECT HEADLINE (HTML fallback)            -->
<!-- ============================================================ -->
...
[![Email](https://img.shields.io/badge/Email-mofaheemkhan614%40gmail.com-ea4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:mofaheemkhan614@gmail.com)
...
<svg width="800" height="4" xmlns="http://www.w3.org/2000/svg">
  <defs>
  ...
  <rect width="800" height="4" rx="2" fill="url(#div1)"/>
</svg>
...
|:---|:---|:---|
| **CompTIA Security+** | CompTIA | Access Control · Cryptography · Network Security · Threat Detection · Incident Response |
| **Google Cybersecurity Certificate** | Google / Coursera | SIEM Operations · Linux CLI · SQL Log Analysis · Python Scripting · IDS Fundamentals |
| **Software Security** | Academic | Threat Modeling · PKI · SSDLC · Black/White Box Testing · Defensive Tactics |
| **Mastercard Cybersecurity** | Forage | Phishing Analysis · Security Awareness · Training Program Development |
| **Tata Cybersecurity Analyst** | Forage / TCS | IAM · Access Control Assessment · Technical Documentation · Stakeholder Reporting |
...
<!-- ============================================================ -->
<!--  BENTO BOX GRID — PROJECT GALLERY                           -->
<!-- ============================================================ -->
...
- Acted as Security Analyst on Mastercard's Security Awareness Team
...
### 🔐 Tata IAM Security Assessment
> **Platform:** Forage / Tata Consultancy Services

- Simulated cybersecurity analyst for TCS engagement
- Focused on **Identity and Access Management (IAM)**
- Assessed access controls against security best practices
- Produced **technical documentation** and stakeholder decks
- Aligned remediation recommendations with business goals

`IAM` `Access Control` `Technical Writing` `GRC`
...
<!-- ============================================================ -->
<!--  EXPERIENCE TIMELINE — BENTO LAYOUT                         -->
<!-- ============================================================ -->
...
`Risk Management` `Network Defense`
...
`OOP` `Data Structures`
`Database Systems` `OS Fundamentals`
...
![GitHub Stats](https://github-readme-stats.vercel.app/api?username=faheemkhan09&show_icons=true&theme=tokyonight&hide_border=true&bg_color=0d1117&title_color=00ff88&icon_color=7c3aed&text_color=c9d1d9)

![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=faheemkhan09&layout=compact&theme=tokyonight&hide_border=true&bg_color=0d1117&title_color=00ff88&text_color=c9d1d9)

[![GitHub Streak](https://streak-stats.demolab.com?user=faheemkhan09&theme=tokyonight&hide_border=true&background=0d1117&ring=00ff88&fire=7c3aed&currStreakLabel=00ff88)](https://git.io/streak-stats)
...
<svg width="800" height="4" xmlns="http://www.w3.org/2000/svg">
  ...
  <rect width="800" height="4" rx="2" fill="url(#div2)"/>
</svg>

<br/>

<sub>
  <code>// Built with precision · Secured by design · Defending the digital frontier</code>
</sub>

![Profile Views](https://komarev.com/ghpvc/?username=faheemkhan09&color=00ff88&style=flat-square&label=Profile+Views)
